...
<section>
	<form action="<%=request.getContextPath()%>/regist/insert" class="container" method="post" onsubmit="return fn_registEnrollMember();"> 
        <br>
...
<!--                 &nbsp;
            ...
            <!-- 아이디  -->
<%--              <div class="id">
                <input type="text" placeholder="아이디" id="userId_" name="userId" required readonly="readonly" value="${id}"> 
            ...
            <!-- 이름 -->
            <div>
                <input type="text" placeholder="이름" id="username" name="username" required  readonly="readonly" value="${nickname}">
            </div>
