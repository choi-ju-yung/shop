...
-- ── PC/모바일 ──
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 21, '아이폰 15 Pro 256GB 블랙 미개봉',           '스마트폰', '서울 강남구',   '미개봉',     1350000, '아이폰 15 Pro 256GB 블랙 미개봉 제품입니다. 선물용으로 구매했으나 기기변경으로 판매합니다. 박스 실링 그대로입니다.',                     '아이폰,iPhone,애플,Apple,스마트폰,미개봉');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 22, '갤럭시 S24 울트라 256GB 티타늄블랙',        '스마트폰', '서울 송파구',   '미개봉',     1280000, '갤럭시 S24 울트라 256GB 티타늄블랙 미개봉 새상품입니다. 구매 후 개통하지 않았습니다. 구성품 모두 포함.',                                  '갤럭시,삼성,S24,울트라,스마트폰,미개봉');
...
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 26, '갤럭시 탭 S9 FE 256GB 실버 Wi-Fi',         '태블릿',   '광주 북구',     '미개봉',      520000, '갤럭시 탭 S9 FE 256GB 실버 Wi-Fi 미개봉 새상품입니다. 구매 후 쓸 일이 없어 바로 판매합니다.',                                               '갤럭시탭,삼성,태블릿,S9FE,미개봉');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 27, '애플워치 Series 9 45mm GPS 미드나이트',     '스마트폰', '부산 수영구',   '미개봉',      430000, '애플워치 시리즈 9 45mm GPS 미드나이트 미개봉입니다. 선물용으로 구매했으나 사용 안 합니다.',                                                 '애플워치,AppleWatch,스마트워치,애플');

-- ── 가전제품 ──
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 28, '삼성 QLED TV 65인치 2022년형',              'TV/영상',  '부산 해운대구', '사용감 있음', 620000, '삼성 QLED 65인치 TV입니다. 2022년 구매 후 이사로 판매합니다. 작동 이상 없으며 리모컨 포함입니다.',                                          '삼성,TV,QLED,65인치,텔레비전');
...
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 31, '삼성 비스포크 냉장고 4도어 800L 코타차콜', '냉장고',   '경기 성남시',   '사용감 있음', 1100000,'삼성 비스포크 냉장고 4도어 800L 코타차콜입니다. 2021년 구매 후 이사로 판매합니다. 작동 이상 없음.',                                           '삼성,비스포크,냉장고,4도어');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 32, 'LG 트롬 세탁기 21kg 화이트',               '세탁기',   '인천 미추홀구', '사용감 있음', 420000, 'LG 트롬 세탁기 21kg입니다. 2022년 구매 후 사용 중이었으나 이사로 판매합니다. 정상 작동 확인.',                                              'LG,세탁기,트롬,드럼세탁기');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 21, '다이킨 에어컨 18평형 인버터 스탠드',       '에어컨',   '서울 노원구',   '사용감 있음', 680000, '다이킨 인버터 스탠드 에어컨 18평형입니다. 2020년 구매. 매년 청소 완료. 직거래만 가능합니다.',                                               '다이킨,에어컨,스탠드에어컨,인버터');
...
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 24, '뉴발란스 992 그레이 275mm',                 '신발',     '경기 고양시',   '사용감 있음',  65000, '뉴발란스 992 그레이 275mm 판매합니다. 자주 착용했으나 상태 양호합니다. 박스 없음.',                                                         '뉴발란스,NewBalance,992,운동화');
...
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 27, '구찌 GG 숄더백 미니 오피디아',              '가방',     '서울 강남구',   '사용감 있음', 650000, '구찌 오피디아 GG 미니 숄더백입니다. 1년 정도 사용하였으며 정품입니다. 보증카드 및 더스트백 포함.',                                             '구찌,Gucci,가방,숄더백,명품');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 28, '롤렉스 서브마리너 데이트 블랙다이얼',       '시계/주얼리','서울 서초구', '사용감 있음', 12500000,'롤렉스 서브마리너 데이트 블랙다이얼 2019년형입니다. 풀박스 풀페이퍼 있습니다. 정품 보증.',                                                  '롤렉스,Rolex,서브마리너,시계,명품시계');

-- ── 가구/인테리어 ──
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 29, '이케아 KALLAX 책장 4x4 화이트',             '수납/정리', '서울 마포구',  '사용감 있음',  55000, '이케아 KALLAX 4x4 칸 책장 화이트입니다. 이사 정리로 판매합니다. 분해 가능하며 직접 가져가실 분만 구매 가능합니다.',                          '이케아,KALLAX,책장,수납,인테리어');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 30, '한샘 소파 3인용 패브릭 그레이',             '소파/침대', '서울 강동구',  '사용감 있음', 180000, '한샘 3인용 패브릭 소파 그레이입니다. 이사로 판매합니다. 직접 가져가실 분만 구매 가능합니다.',                                               '소파,한샘,3인용소파,패브릭소파');
...
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 21, '트렉 마린 5 로드바이크 2022 52사이즈',      '자전거',   '경기 과천시',   '사용감 있음', 780000, '트렉 마린 5 로드바이크 2022년형 52사이즈입니다. 1년 사용. 기어 변속 정상. 타이어 교체 완료.',                                                '자전거,로드바이크,트렉,Trek,사이클');
...
-- ── 도서/음반 ──
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 24, '해리포터 전집 양장본 1~7권 세트',           '도서',     '대전 유성구',   '사용감 있음',  35000, '해리포터 전집 1권부터 7권까지 완전 세트입니다. 전체적으로 깨끗하며 일부 모서리 살짝 눌린 자국 있습니다.',                                     '해리포터,전집,소설,도서,책');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 25, '2025 SQLD 자격증 교재 + 기출문제집 세트',   '도서',     '서울 관악구',   '사용감 있음',  18000, 'SQLD 자격증 교재와 기출문제집 세트입니다. 필기 후 합격하여 판매합니다. 깔끔하게 사용했습니다.',                                               'SQLD,자격증,교재,도서,IT자격증');
INSERT INTO PRODUCT VALUES (TO_CHAR(PRODUCT_ID_SEQ.NEXTVAL), 26, '방탄소년단 BTS Proof Standard Edition',      'CD/DVD',   '광주 광산구',   '미개봉',       22000, 'BTS Proof Standard Edition 미개봉 앨범입니다. 구매 후 미개봉 보관 중이던 제품입니다.',                                                       'BTS,방탄소년단,Proof,앨범,CD');
